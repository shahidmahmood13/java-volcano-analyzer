...
public class VolcanoAnalyzerTests {
    ...
    public void highVEIVolcanoes() {
        ...
        //Execute
        String[] actual = va.highVEIVolcanoes();
    ...
    public void deadliestVolcano() {
        ...
        //Execute
        Volcano actual = va.deadliestVolcano();
    ...
    @Test
    public void tsunamiPercentage() {
        //Setup
        double expected = 17;

        //Execute
        double actual = va.tsunamiPercentage();
    ...
    @Test
    public void mostCommonVolcanoType() {
        //Setup
        String expected = "Stratovolcano";

        //Execute
        String actual = va.mostCommonVolcanoType();
    ...
    @Test
    public void avgEruptionElevation() {
        //Setup
        double expected = 1993.71;

        //Execute
        double actual = va.avgEruptionElevation();
    ...
    public void allVolcanoTypes() {
        ...
        //Execute
        String[] actual = va.allVolcanoTypes();
    ...
    @Test
    public void northernHemiEruptionsPercentage() {
        //Setup
        double expected = 64.55;

        //Execute
        double actual = va.northernHemiEruptionsPercentage();
    ...
    @Test
    public void verySpecificVolcanoes() {
        //Setup
        String[] expected = { "Galunggung", "Hudson, Cerro" };
        //Execute
        String[] actual = va.verySpecificVolcanoes();
    ...
    @Test
    public void volcanoesAboveElevation() {
        //Setup
        ...
        //Execute
        String[] actual = va.volcanoesAboveElevation(4990);
    ...
    @Test
    public void topTenDeadliestEruptionAgents() {
        //Setup
        String[] expected = { "P", "M", "W", "A", "I" };

        //Execute
        String[] actual = va.topTenDeadliestEruptionAgents();
